...
"""
This script will check for duplicates in a CartoDB dataset. It does
this by comparing feature hashes across the dataset and checking for
matches.
"""
...
def main():
    ...
    logging.info("Downloading feature hashes from table '%s'.",
        options.tablename)
